  ...
  return (
    <div className='container px-2 sm:m-auto'>
      ...
      <div className='mx-auto flex my-2'>
        ...
        <textarea name='address' id='address' cols='30' rows='2' id="address" name="address" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
        Phone
        City
        State
        Pincode
        ...
        <h2 className='font-semibold text-xl'>1. Review Cart Items & Pay</h2>
        <div className='sidecart bg-indigo-400 p-6 m-2'>
...
<span className='font-bold'>Subtotal: ₹{subTotal} </span>
      ...
      <div className='mx-4 '>
      <Link href ={'/checkout'}><button className="flex mr-2 text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded text-sm"><BsFillBagCheckFill className='m-1'/>Pay ₹ {subTotal} </button></Link>
      </div>
    </div>
  )
}
